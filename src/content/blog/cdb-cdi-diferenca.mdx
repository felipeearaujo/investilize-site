...
title: "Diferença entre CDB e CDI: O Guia Definitivo e Simples"
description: "Na dúvida entre investir em CDB ou focar no CDI? Explicamos as taxas, os rendimentos reais e qual é o melhor para o seu dinheiro. Confira!"
author: 'Felipe'
pubDate: '2026-04-10'
...
> **🚀 Não faça contas de cabeça!** Use nosso [Simulador Grátis de CDB vs LCI](https://investilize.com.br/ferramentas/comparador-renda-fixa/) para descobrir o rendimento real dos seus investimentos, já com o desconto automático do Imposto de Renda.
...
**Como saber o valor do CDI hoje?**
A taxa DI anda sempre colada na taxa Selic (a taxa básica de juros da economia). Em geral, o CDI rende cerca de 0,10 ponto percentual a menos que a Selic anual. Você pode acompanhar a variação exata destas taxas em tempo real no nosso [Taxômetro Exclusivo](https://investilize.com.br/ferramentas/Taxometro).
...
O CDB, por outro lado, paga um percentual maior (frequentemente 100\% a 110\% do CDI) e pode oferecer resgate imediato, mas **sofre desconto do IR sobre os lucros**. Para saber quem ganha esse duelo na ponta do lápis, é essencial usar um [Comparador de Renda Fixa](https://investilize.com.br/ferramentas/comparador-renda-fixa/).
...
> **Dica de Ouro:** Quer descobrir se os juros do seu CDB estão superando a inflação real? Use nossa ferramenta para [Calcular o seu Poder de Compra Atualizado](https://investilize.com.br/ferramentas/poder-de-compra/) e descubra se o seu dinheiro está realmente crescendo.
...
* **Onde usar:** CDBs que pagam pelo menos 100\% do CDI com "Liquidez Diária" são as melhores opções para guardar a sua [Reserva de Emergência](https://investilize.com.br/ferramentas/calculadora-reserva-emergencia).
