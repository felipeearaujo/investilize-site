...
1.  **Juros Simples:** O rendimento é calculado sempre sobre o valor original. Se você investe R\$ 1.000 a 10\% ao mês, ganharã R\$ 100 fixos todos os meses.
...
Neste cenãrio, quase metade do valor final foi gerado "sozinho" pelo efeito multiplicador, sem que a Ana precisasse trabalhar mais por isso.

---

### Exemplo Prãtico 2: O Perigo da Dívida do Carlos
