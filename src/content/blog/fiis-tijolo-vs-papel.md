---
title: 'FIIs de Tijolo vs. Papel: Qual o Melhor? Entenda a Diferença Definitiva'
description: 'Saiba a diferença entre FIIs de Tijolo (imóveis físicos) e Papel (CRIs). Entenda os riscos de cada um (vacância, crédito) e qual é melhor para sua carteira.'
author: 'Felipe'
pubDate: '2025-11-06' 
...
faqList:
  ...
  - question: "Qual paga mais dividendos, Tijolo ou Papel?"
    answer: "Geralmente, FIIs de Papel tendem a pagar dividendos maiores, pois seus ganhos são atrelados a taxas de juros (CDI) ou inflação (IPCA), que costumam ser altas no Brasil. FIIs de Tijolo têm seus ganhos atrelados a contratos de aluguel, que são reajustados anualmente."
  - question: "Preciso escolher um ou posso ter os dois?"
    answer: "O ideal é ter os dois. A diversificação é a melhor estratégia. FIIs de Tijolo protegem seu patrimônio com imóveis físicos, enquanto FIIs de Papel costumam turbinar seus rendimentos mensais com juros e inflação."
---

Você aprendeu [**o que são Fundos Imobiliários (FIIs)**](https://investilize.com.br/blog/o-que-sao-fiis/) e se animou para receber "aluguéis" mensais. Mas, ao abrir a lista de fundos na corretora, você se deparou com os termos "FIIs de Tijolo" e "FIIs de Papel".
...
1. **Com o aluguel:** O fundo aluga os imóveis para grandes inquilinos (empresas, lojas, etc.) e distribui o valor para os cotistas.
2. **Com a valorização:** O preço dos imóveis do fundo pode subir com o tempo, valorizando o patrimônio total do FII.

Eles são divididos por setores, como:

* **Shoppings Centers:** (Ex: `XPML11`) Ganham com o aluguel das lojas.
* **Lajes Corporativas:** (Ex: `HGRE11`) Alugam andares de escritórios para empresas.
* **Galpões Logísticos:** (Ex: `HGLG11`) Alugam galpões para empresas de e-commerce e indústria.
* **Outros:** Hospitais, Hotéis, Supermercados, Agências Bancárias, etc.
