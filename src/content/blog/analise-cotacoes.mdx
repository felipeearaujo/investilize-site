...
description: 'Aprenda os fundamentos da análise de ações, da abordagem fundamentalista à técnica, e os principais indicadores para investir com segurança e assertividade.'
pubDate: '2025-08-07'
...
import CalculadoraPrecoJusto from '../../components/ferramentas/CalculadoraPrecoJusto.astro';

A análise de cotações vai muito além de observar um gráfico de velas. Para o investidor que busca o longo prazo, o segredo reside na margem de segurança. 

## Calculadora de Preço Justo (Graham & Gordon)

Use o simulador abaixo para calcular se o ativo que você está analisando está abaixo do seu valor intrínseco:

<CalculadoraPrecoJusto />

### Como interpretar o resultado?
Como você acabou de simular, o preço justo é uma estimativa baseada em fundamentos. Se a cotação atual na B3 estiver muito acima do resultado da calculadora, o ativo pode estar sobrevalorizado...
