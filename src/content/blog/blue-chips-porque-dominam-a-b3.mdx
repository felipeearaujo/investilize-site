...
<div style="background-color: #1a1a1a; padding: 20px; border-left: 5px solid #d4a373; margin: 25px 0;">
    <p style="margin: 0; font-weight: bold; color: #d4a373; font-size: 1.1rem;">O Poder das Blue Chips na Carteira</p>
    <ul style="margin: 8px 0 0 20px; font-size: 0.95rem; color: #e5e5e5; line-height: 1.6;">
